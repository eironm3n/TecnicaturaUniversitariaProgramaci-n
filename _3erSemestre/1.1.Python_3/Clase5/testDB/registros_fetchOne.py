...
try:
    with conexion:
        with conexion.cursor() as cursor:
            ...
            registros2 = cursor.fetchall()   # Recuperamos todos los registros que serán una lista
            ...
            registros3 = cursor.fetchall()   # Recuperamos todos los registros en una lista
            ...
            registros4 = cursor.fetchall()   # Recuperamos todos los registros en una lista
            print("Soy parametro establecido por un placeholder ",registros2)
